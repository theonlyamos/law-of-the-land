...
vi.mock("@/components/admin/analytics-charts", () => ({ AnalyticsCharts: () => <section aria-label="Lazy analytics charts" /> }));
...
beforeEach(() => {
  ...
  mocks.fetchAuthQuery.mockResolvedValue({
    page: [{ id: "metric-1", day: "2026-07-28", jurisdictionCode: "GH", totalQuestions: 15, successCount: 14, failureCount: 1, abortedCount: 0, providerFailureCount: 1, noResultCount: 3, p50LatencyMs: 500, p95LatencyMs: 1000, updatedAt: Date.now() }],
    isDone: false,
