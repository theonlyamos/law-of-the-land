  ...
  return (
    <article className="mx-auto max-w-[88rem]">
      <header className="grid gap-5 border-b-2 border-[oklch(35%_0.055_252)] pb-8 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-end">
        ...
        <p className="text-sm leading-6 text-[oklch(40%_0.035_252)]">Inspect evidence, record an immutable legal decision, then promote the approved staging document without re-ingesting its original.</p>
      </header>
      <div className="mt-10">
